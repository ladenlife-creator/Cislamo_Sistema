...
class SchoolController extends Controller
{
    ...
    /**
     * Public endpoint for testing - returns schools without authentication
    ...
    /**
     * Public endpoint for testing - creates school without authentication
     * TEMPORARY - Remove in production
     */
    public function publicStore(CreateSchoolRequest $request): JsonResponse
    {
        try {
