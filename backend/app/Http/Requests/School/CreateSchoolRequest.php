...
class CreateSchoolRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'language_instruction' => 'required|array|min:1',
            ...
            'status' => 'nullable|in:setup,active,maintenance,suspended,archived',
    ...
    public function messages(): array
    {
        return [
            ...
            'educational_levels.min' => 'At least one educational level must be selected.',
            ...
            'address_json.required' => 'Address information is required.',
            'country_code.required' => 'Country code is required.',
            'country_code.size' => 'Country code must be exactly 2 characters.',
            'city.required' => 'City is required.',
            'language_instruction.required' => 'Language instruction is required.',
            'language_instruction.min' => 'At least one language must be selected.',
            'accreditation_status.in' => 'Invalid accreditation status.',
            'academic_calendar_type.in' => 'Invalid academic calendar type.',
            'grading_system.in' => 'Invalid grading system.',
            'attendance_tracking_level.in' => 'Invalid attendance tracking level.',
            'subscription_plan.in' => 'Invalid subscription plan.',
