    ...
    private function createTeachers(int $tenantId, int $schoolId, int $userId): array
    {
        $teachers = [
            [
                ...
                'email' => 'john.smith@acmeacademy.edu',
                'phone' => '+1-555-0101',
                'gender' => 'male',
            ...
            [
                ...
                'email' => 'sarah.johnson@acmeacademy.edu',
                'phone' => '+1-555-0102',
                'gender' => 'female',
                'nationality' => 'American',
            ],
            [
                ...
                'specializations_json' => ['biology', 'chemistry', 'physics'],
                'email' => 'michael.brown@acmeacademy.edu',
                'phone' => '+1-555-0103',
                'gender' => 'male',
            ...
            [
                ...
                'department' => 'History',
                'position' => 'Teacher',
                'specializations_json' => ['world_history', 'american_history', 'geography'],
                'email' => 'emily.davis@acmeacademy.edu',
                'phone' => '+1-555-0104',
                'gender' => 'female',
                'nationality' => 'British',
            ],
            [
                ...
                'position' => 'Coach',
                'specializations_json' => ['sports', 'fitness', 'health'],
                'email' => 'david.wilson@acmeacademy.edu',
                'phone' => '+1-555-0105',
                'gender' => 'male',
