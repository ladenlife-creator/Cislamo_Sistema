...
class AllPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call([
            \Database\Seeders\permissions\AcademicPermissionsSeeder::class,
            \Database\Seeders\permissions\AssessmentPermissionsSeeder::class,
            \Database\Seeders\permissions\TransportPermissionsSeeder::class,
        ]);
