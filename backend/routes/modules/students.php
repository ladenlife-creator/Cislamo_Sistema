...
// Public endpoint for testing - student documents without authentication
// TEMPORARY - Remove in production
Route::get('/student-documents/public', [\App\Http\Controllers\API\V1\Student\StudentDocumentController::class, 'publicIndex']);
